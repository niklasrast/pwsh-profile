<#
    .SYNOPSIS 
    Niklas PowerShell Profile

    .DESCRIPTION
    Usefull Functions within MS PowerShell to Automate Workflows
...
Function Get-CustomDirectory {
    ...
    Begin
    {
        ...
        $CustomDirectories = @{
            ...
            "C:\Users\$ENV:USERNAME\Desktop"                                ='Desktop'
            "C:\Users\$ENV:USERNAME\OneDrive"                               ='OneDrive'
            "C:\Data"                                                       ='Data'
            "C:\TEMP"                                                       ='TEMP'
            "Microsoft.PowerShell.Core\FileSystem::"                        ='REMOTE:'
        } 
    }
    Process
    {
...
# Load Modules
Import-Module C:\Users\$ENV:USERNAME\Documents\WindowsPowerShell\Module\MicrosoftGraphIntune\6.1907.1\Microsoft.Graph.Intune.psd1
Import-Module C:\Users\$ENV:USERNAME\Documents\WindowsPowerShell\Module\AzureAD\2.0.2.130\AzureAD.psd1
...
function GeneratePassword {
    ...
    [System.Web.Security.Membership]::GeneratePassword($PasswordLength,$NonAlphCh)
}
...
function GetMSIProductCode {
    ...
    Get-AppLockerFileInformation -Path $msiname | Select-Object -ExpandProperty Publisher | Select-Object BinaryName
}
...
function ps2exe {
    ...
    Write-Output "PS2EXE-GUI v0.5.0.17 by Ingo Karstein, reworked and GUI support by Markus Scholtes`n"
